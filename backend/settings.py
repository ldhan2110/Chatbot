...
class Settings(BaseSettings):
    ...
    # For deep research
    lead_research_llm_model: str = "gemini-1.5-flash"
    subagent_research_llm_model: str = "gemini-1.5-flash"
    ...
    def model(self) -> Model:
        if self.llm_provider == "openai":
            return OpenAIChatModel(model_name=self.llm_model, provider="openai")
